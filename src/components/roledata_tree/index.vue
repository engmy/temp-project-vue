<template>
  <div class="role-tree">
    ...
    <div class="scroller">
      <el-tree :data="list" :props="props" :default-checked-keys="checked" :filter-node-method="filterNode" highlight-current node-key="ids" show-checkbox ref="tree" @check-change="save" :default-expanded-keys="checked" />
    </div>
  </div>
</template>
...
export default {
  ...
  setup(props, context) {
    ...
    return { tree, ...toRefs(state), filterNode, save, clear }
  }
}
</script>
